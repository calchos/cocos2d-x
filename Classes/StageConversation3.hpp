#ifndef StageConversation3_hpp
#define StageConversation3_hpp
...
class StageConversation3 : public cocos2d::Layer // 派生クラス HelloWorld作成
{
...
public:
    ...
    CREATE_FUNC(StageConversation3);
