...
bool Stage2::init()
{
    ...
    listener->onTouchBegan = CC_CALLBACK_2(Stage2::onTouchBegan, this);//タッチしたときに1回だけ処理を実行
    ...
    _enemy1->setPosition(Vec2(origin.x + 150, origin.y + visibleSize.height / 2 + 30));
...
// 画面をタッチした時の処理
bool Stage2::onTouchBegan(Touch* pTouch, Event* pEvent){
